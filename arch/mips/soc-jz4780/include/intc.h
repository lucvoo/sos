...
#define	INTC_IRQ_UART0		INTC_IRQ(1, 19)
#define	INTC_IRQ_UART1		INTC_IRQ(1, 18)
#define	INTC_IRQ_UART2		INTC_IRQ(1, 17)
#define	INTC_IRQ_UART3		INTC_IRQ(1, 16)
#define	INTC_IRQ_UART4		INTC_IRQ(1,  2)
