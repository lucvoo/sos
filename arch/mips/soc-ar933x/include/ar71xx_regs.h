/*
 *  Atheros AR71XX/AR724X/AR913X/AR933X SoC register definitions
 *
...
#ifndef _SOC_AR71XX_REGS_H_
#define _SOC_AR71XX_REGS_H_
...
#define AR71XX_SPI_SIZE		 0x1000000
...
#define AR933X_PLL_CPU_CONFIG_DIVINT(X)		(((X) >> 10) & 0x3f)
#define AR933X_PLL_CPU_CONFIG_REFDIV(X)		(((X) >> 16) & 0x1f)
#define AR933X_PLL_CPU_CONFIG_OUTDIV(X)		(((X) >> 23) & 0x7)

#define AR933X_PLL_CPU_CONFIG2_REG	0x04

#define AR933X_PLL_CLOCK_CTRL_REG	0x08
#define AR933X_PLL_CLOCK_CTRL_BYPASS		(1 << 2)
#define AR933X_PLL_CLOCK_CTRL_CPU_DIV(X)	((((X) >>  5) & 0x3) + 1)
#define AR933X_PLL_CLOCK_CTRL_DDR_DIV(X)	((((X) >> 10) & 0x3) + 1)
#define AR933X_PLL_CLOCK_CTRL_AHB_DIV(X)	((((X) >> 15) & 0x7) + 1)

#define AR933X_ETHSW_CLOCK_CTRL		0x24
#define AR933X_ETHSW_CLOCK_CTRL_CORE_BIAS	(1 << 4)
#define AR933X_ETHSW_CLOCK_CTRL_CORE_PLL_PWD	(1 << 3)
...
#define QCA955X_PLL_CLK_CTRL_CPU_PLL_BYPASS		(1 << 2)
#define QCA955X_PLL_CLK_CTRL_DDR_PLL_BYPASS		(1 << 3)
#define QCA955X_PLL_CLK_CTRL_AHB_PLL_BYPASS		(1 << 4)
...
#define QCA955X_PLL_CLK_CTRL_CPUCLK_FROM_CPUPLL		(1 << 20)
#define QCA955X_PLL_CLK_CTRL_DDRCLK_FROM_DDRPLL		(1 << 21)
#define QCA955X_PLL_CLK_CTRL_AHBCLK_FROM_DDRPLL		(1 << 24)
#endif
...
#define AR71XX_RESET_EXTERNAL		(1 << 28)
#define AR71XX_RESET_FULL_CHIP		(1 << 24)
#define AR71XX_RESET_CPU_NMI		(1 << 21)
#define AR71XX_RESET_CPU_COLD		(1 << 20)
#define AR71XX_RESET_DMA		(1 << 19)
#define AR71XX_RESET_SLIC		(1 << 18)
#define AR71XX_RESET_STEREO		(1 << 17)
#define AR71XX_RESET_DDR		(1 << 16)
#define AR71XX_RESET_GE1_MAC		(1 << 13)
#define AR71XX_RESET_GE1_PHY		(1 << 12)
#define AR71XX_RESET_USBSUS_OVERRIDE	(1 << 10)
#define AR71XX_RESET_GE0_MAC		(1 << 9)
#define AR71XX_RESET_GE0_PHY		(1 << 8)
#define AR71XX_RESET_USB_OHCI_DLL	(1 << 6)
#define AR71XX_RESET_USB_HOST		(1 << 5)
#define AR71XX_RESET_USB_PHY		(1 << 4)
#define AR71XX_RESET_PCI_BUS		(1 << 1)
#define AR71XX_RESET_PCI_CORE		(1 << 0)

#if 0
#define AR7240_RESET_USB_HOST		(1 << 5)
#define AR7240_RESET_OHCI_DLL		(1 << 3)
...
#define AR913X_RESET_AMBA2WMAC		(1 << 22)
#define AR913X_RESET_USBSUS_OVERRIDE	(1 << 10)
#define AR913X_RESET_USB_HOST		(1 << 5)
#define AR913X_RESET_USB_PHY		(1 << 4)
...
#define AR933X_RESET_REG_RESET		0x1c
#define AR933X_RESET_GE1_MDIO			(1 << 23)
#define AR933X_RESET_GE0_MDIO			(1 << 22)
#define AR933X_RESET_GE1_MAC			(1 << 13)
#define AR933X_RESET_WMAC			(1 << 11)
#define AR933X_RESET_GE0_MAC			(1 << 9)
#define AR933X_RESET_ETH_SWITCH			(1 << 8)
#define AR933X_RESET_USB_HOST			(1 << 5)
#define AR933X_RESET_USB_PHY			(1 << 4)
#define AR933X_RESET_USB_SUSPEND_OVERRIDE	(1 << 3)

#define AR933X_RESET_REG_BOOTSTRAP	0xac
#define AR933X_BOOTSTRAP_MDIO_GPIO_EN		(1 << 18)
#define AR933X_BOOTSTRAP_MDIO_SLAVE_EN		(1 << 17)
#define AR933X_BOOTSTRAP_EEPBUSY		(1 << 4)
...
#define MISC_INT_ETHSW			(1 << 12)
#define MISC_INT_TIMER4			(1 << 10)
#define MISC_INT_TIMER3			(1 << 9)
#define MISC_INT_TIMER2			(1 << 8)
#define MISC_INT_DMA			(1 << 7)
#define MISC_INT_OHCI			(1 << 6)
#define MISC_INT_PERFC			(1 << 5)
#define MISC_INT_WDOG			(1 << 4)
#define MISC_INT_UART			(1 << 3)
#define MISC_INT_GPIO			(1 << 2)
#define MISC_INT_ERROR			(1 << 1)
#define MISC_INT_TIMER			(1 << 0)
...
#define QCA955X_BOOTSTRAP_REF_CLK_40	(1 << 4)
...
#define QCA955X_EXT_INT_WMAC_MISC		(1 << 0)
#define QCA955X_EXT_INT_WMAC_TX			(1 << 1)
#define QCA955X_EXT_INT_WMAC_RXLP		(1 << 2)
#define QCA955X_EXT_INT_WMAC_RXHP		(1 << 3)
#define QCA955X_EXT_INT_PCIE_RC1		(1 << 4)
#define QCA955X_EXT_INT_PCIE_RC1_INT0		(1 << 5)
#define QCA955X_EXT_INT_PCIE_RC1_INT1		(1 << 6)
#define QCA955X_EXT_INT_PCIE_RC1_INT2		(1 << 7)
#define QCA955X_EXT_INT_PCIE_RC1_INT3		(1 << 8)
#define QCA955X_EXT_INT_PCIE_RC2		(1 << 12)
#define QCA955X_EXT_INT_PCIE_RC2_INT0		(1 << 13)
#define QCA955X_EXT_INT_PCIE_RC2_INT1		(1 << 14)
#define QCA955X_EXT_INT_PCIE_RC2_INT2		(1 << 15)
#define QCA955X_EXT_INT_PCIE_RC2_INT3		(1 << 16)
#define QCA955X_EXT_INT_USB1			(1 << 24)
#define QCA955X_EXT_INT_USB2			(1 << 28)
...
#define AR71XX_SPI_FS_GPIO	(1 << 0)	/* Enable GPIO mode */

#define AR71XX_SPI_CTRL_RD	(1 << 6)	/* Remap Disable */
#define AR71XX_SPI_CTRL_DIV_MASK 0x3f

#define AR71XX_SPI_IOC_DO	(1 << 0)	/* Data Out pin */
#define AR71XX_SPI_IOC_CLK	(1 << 8)	/* CLK pin */
#define AR71XX_SPI_IOC_CS(n)	(1 << 16 + (n))
...
#define AR71XX_GPIO_FUNC_STEREO_EN		(1 << 17)
#define AR71XX_GPIO_FUNC_SLIC_EN		(1 << 16)
#define AR71XX_GPIO_FUNC_SPI_CS2_EN		(1 << 13)
#define AR71XX_GPIO_FUNC_SPI_CS1_EN		(1 << 12)
#define AR71XX_GPIO_FUNC_UART_EN		(1 << 8)
#define AR71XX_GPIO_FUNC_USB_OC_EN		(1 << 4)
#define AR71XX_GPIO_FUNC_USB_CLK_EN		(1 << 0)
...
#define AR913X_GPIO_FUNC_WMAC_LED_EN		(1 << 22)
#define AR913X_GPIO_FUNC_EXP_PORT_CS_EN		(1 << 21)
#define AR913X_GPIO_FUNC_I2S_REFCLKEN		(1 << 20)
#define AR913X_GPIO_FUNC_I2S_MCKEN		(1 << 19)
#define AR913X_GPIO_FUNC_I2S1_EN		(1 << 18)
#define AR913X_GPIO_FUNC_I2S0_EN		(1 << 17)
#define AR913X_GPIO_FUNC_SLIC_EN		(1 << 16)
#define AR913X_GPIO_FUNC_UART_RTSCTS_EN		(1 << 9)
#define AR913X_GPIO_FUNC_UART_EN		(1 << 8)
#define AR913X_GPIO_FUNC_USB_CLK_EN		(1 << 4)

#define AR933X_GPIO_FUNC_SPDIF2TCK		(1 << 31)
#define AR933X_GPIO_FUNC_SPDIF_EN		(1 << 30)
#define AR933X_GPIO_FUNC_I2SO_22_18_EN		(1 << 29)
#define AR933X_GPIO_FUNC_I2S_MCK_EN		(1 << 27)
#define AR933X_GPIO_FUNC_I2SO_EN		(1 << 26)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED_DUPL	(1 << 25)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED_COLL	(1 << 24)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED_ACT	(1 << 23)
#define AR933X_GPIO_FUNC_SPI_EN			(1 << 18)
#define AR933X_GPIO_FUNC_SPI_CS_EN2		(1 << 14)
#define AR933X_GPIO_FUNC_SPI_CS_EN1		(1 << 13)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED4_EN	(1 << 7)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED3_EN	(1 << 6)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED2_EN	(1 << 5)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED1_EN	(1 << 4)
#define AR933X_GPIO_FUNC_ETH_SWITCH_LED0_EN	(1 << 3)
#define AR933X_GPIO_FUNC_UART_RTS_CTS_EN	(1 << 2)
#define AR933X_GPIO_FUNC_UART_EN		(1 << 1)
#define AR933X_GPIO_FUNC_JTAG_DISABLE		(1 << 0)

#define AR934X_GPIO_FUNC_DDR_DQOE_EN	(1 << 17)
#define AR934X_GPIO_FUNC_SPI_CS_1_EN	(1 << 14)
#define AR934X_GPIO_FUNC_SPI_CS_0_EN	(1 << 13)
...
#define AR933X_ETH_CFG_RMII_GE0_SPD_10	(0 << 10)
...
#define AR933X_ETH_CFG_SW_ACC_MSB_FIRST	(1 << 13)
...
#define QCA955X_ETH_CFG_RGMII_GMAC0	(1 << 0)
#define QCA955X_ETH_CFG_SGMII_GMAC0	(1 << 6)
