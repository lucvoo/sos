...
#define	MMC_CMD_MULTI_BLOCK	(1 << 11)
...
#define	MMC_CMD_READ_BLOCKS	MMC_CMD(18, MMC_RSP_R1|MMC_CMD_RDATA|MMC_CMD_MULTI_BLOCK)
#define	MMC_CMD_SET_BLOCK_COUNT	MMC_CMD(23, MMC_RSP_R1)
#define	MMC_CMD_WRITE_BLOCK	MMC_CMD(24, MMC_RSP_R1|MMC_CMD_WDATA)
#define	MMC_CMD_WRITE_BLOCKS	MMC_CMD(25, MMC_RSP_R1|MMC_CMD_WDATA|MMC_CMD_MULTI_BLOCK)
